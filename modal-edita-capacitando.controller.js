(function() {
    ...
    function ModalEditaCapacitandoController($modalInstance, $timeout, $rootScope, registroEditar, Capacitandos, CatalogoLocalidades, CatalogoNivelEstudios, CatalogoActividades, CatalogoExperiencias, CatalogoMedios, CatalogoMotivos) {
            ...
            vm.registroEditar = {
                ...
                apellidoPaternoValidado     : registroEditar.apellidoPaternoValidado,
                apellidoMaternoValidado     : registroEditar.apellidoMaternoValidado,
                nombreValidado              : registroEditar.nombreValidado,
                nombreCompletoValidado              : registroEditar.nombreCompletoValidado,
                ...
                curpValidado        : registroEditar.curpValidado,
                    ...
                    else
                    {
                        ...
                        .then(function(resp) {
                            ...
                            else
                            {
                                ...
                                //Validar cambios en el nombre y curp
                                if(vm.registroEditar.apellidoPaterno != vm.registroEditar.apellidoPaternoValidado || 
                                    vm.registroEditar.apellidoMaterno != vm.registroEditar.apellidoMaternoValidado || 
                                    vm.registroEditar.nombre != vm.registroEditar.nombreValidado || 
                                    vm.registroEditar.curp != vm.registroEditar.curpValidado){
                                        vm.registroEditar.apellidoPaternoValidado = '';
                                        vm.registroEditar.apellidoMaternoValidado = '';
                                        vm.registroEditar.nombreValidado = '';
                                        vm.registroEditar.nombreCompletoValidado = '';
                                        vm.registroEditar.curpValidado = '';
                                }
                                Capacitandos.prototype$updateAttributes(
                                {
                                    ...
                                    apellidoPaternoValidado : vm.registroEditar.apellidoPaternoValidado,
                                    apellidoMaternoValidado : vm.registroEditar.apellidoMaternoValidado,
                                    nombreValidado          : vm.registroEditar.nombreValidado,
                                    nombreCompletoValidado  : vm.registroEditar.nombreCompletoValidado,
                                    ...
                                    curp                : vm.registroEditar.curp,
                                    curpValidado        : vm.registroEditar.curpValidado,
